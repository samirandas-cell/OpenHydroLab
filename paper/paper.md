...
and hence every table below, by running the test suite against the archived release
(Section 6). Software-citation practice follows Smith et al. [@smith2016software].
...
<https://github.com/samirandas-cell/OpenHydroLab>, and version 1.0.0 — the version
described and verified in this paper — is archived at
[10.5281/zenodo.21635798](https://doi.org/10.5281/zenodo.21635798). The concept DOI
...
archived code, followed by `node tools/manuscript-tables.mjs`. The rainfall record embedded
...
physics-accurate animations for teaching hydraulics and hydrology* (Version 1.0.0)
[Computer software]. <https://doi.org/10.5281/zenodo.21635798>
...
<https://doi.org/10.5281/zenodo.21635798> and is regenerated by the test suite. No other
data were used.
